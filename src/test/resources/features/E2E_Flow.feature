...
#    When I choose the "<airline_name>" Airline flight for my booking
    ...
    Examples:
      | departure_city | destination_city | Success_Message                    | airline_name   |
      | Portland       | Rome             | Thank you for your purchase today! | Lufthansa      |
      | Philadelphia   | Berlin           | Thank you for your purchase today! | Virgin America |
